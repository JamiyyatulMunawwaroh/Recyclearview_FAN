...
public class ReadAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataAnggota = new ArrayList<>(); //arraylist untuk menyimpan data mahasiswa
    ...
    public void getData(){
        ...
        AndroidNetworking.get("http://192.168.43.151/commit/tampil.php")
                            ...
                            try {
                                for (int i = 0; i < response.length(); i++) {
                                    ...
                                    dataAnggota.add(new DataAnggota(
                                            data.getInt("id_anggota"), //"name:/String" diisi sesuai dengan yang di JSON pada read_all.php
                                            data.getString("nama_anggota"), //"name:/String" diisi sesuai dengan yang di JSON pada read_all.php
                                            data.getString("jurusan"), //"name:/String" diisi sesuai dengan yang di JSON pada read_all.php
                                            data.getString("peminatan") //"name:/String" diisi sesuai dengan yang di JSON pada read_all.php
                                    ));
                                }
                                //men inisialisasi adapter RecyclerView yang sudah kita buat sebelumnya
                                ListMahasiswaAdapter adapter = new ListMahasiswaAdapter(ReadAllActivity.this, dataAnggota);
